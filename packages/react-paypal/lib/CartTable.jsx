CartTable = React.createClass({
		...
		for(var idx = 0; idx < this.state.cartItems.length; idx++) {
  				...
  				content.push(<tr key={idx} >
                      ...
                      {this.state.cartItems[idx].name}
			             ...
			             <td>
								      <input type="num" id={idx} ref="textInput" min="0" max="100" value={this.state.cartItems[idx].count} onChange={this.updateCart} />
			             </td>
			        		 <td> 
	...
	render() {
		return( <div className="container" id="paypal-bootstrap-container">
				    <div className="row">
      			  <div className="col-md-12">
					     <div className="panel panel-default">
		              <div className="panel-body table-responsive table-div">
		              <table className="table table-bordered">
		                 <thead className="background-{{getTheme}}">
		                    <tr>
		                       <th>Item</th>
		                       <th>Quantity</th>
		                       <th>Price</th>
		       ...
		       <div className="row">
		        	<div className="col-xs-2 col-xs-offset-5">
		        		<div>
		        			<PaypalForm cartItems={this.state.cartItems} email={this.props.email}/>
		        		</div>
		        	</div>
		        </div>
		       </div>);
